        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white/15 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/25 p-8 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center mb-8">
              ...
              <p className="text-white/90 backdrop-blur-sm">Create your account to get started</p>
            </div>
            ...
            <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`p-4 border-2 rounded-xl text-center transition-all duration-300 backdrop-blur-lg ${
                      formData.role === 'student'
                        ? 'border-white/60 bg-white/25 text-white shadow-xl scale-105'
                        : 'border-white/30 bg-white/15 text-white/90 hover:border-white/40 hover:bg-white/20 hover:scale-102'
                    }`}
                  >
                    <svg className="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    <span className="backdrop-blur-sm">Student</span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="backdrop-blur-sm">Professor</span>
                  </button>
                </div>
              </div>
              ...
              >
                {loading ? (
                  ...
                  <span className="backdrop-blur-sm">Create Account</span>
                )}
              </button>
              ...
              <div className="text-center">
                <p className="text-white/90 backdrop-blur-sm">
                  ...
                  <Link to="/login" className="text-white hover:text-white font-semibold transition-colors duration-200 underline backdrop-blur-sm">
                    Sign in
                  </Link>
                </p>
              </div>
